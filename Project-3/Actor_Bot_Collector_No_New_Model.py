...
# Forward pass function with dropout
...
# Backward pass function for cross-entropy loss
...
# Modified test function to track predictions without dropout
...
def move_bot1(grid, bot_cell, path, aliens, crewmates, time_steps, df):
  ...
  while True:
    ...
    new_row = {'bot_position_x': bot_cell.x, 'bot_position_y': bot_cell.y, 'up_alien_prob': up_alien_probability,  'down_alien_prob': down_alien_probability,  'left_alien_prob': left_alien_probability,  'right_alien_prob': right_alien_probability,
          ...
          'max_prob_cell_x': path[-1][0], 'max_prob_cell_y': path[-1][1], 'up_x': up_cell_x,'up_y': up_cell_y,'down_x': down_cell_x,'down_y': down_cell_y,'left_x': left_cell_x,'left_y': left_cell_y,'right_x': right_cell_x,'right_y': right_cell_y}

  # Append the new row to the DataFrame
    # df = df.append(new_row, ignore_index=True)
    predicted_df.loc[len(df)] = new_row
  ...
  return "The bot has rescued a crewmate", bot_cell, crewmates, grid, aliens,time_steps, df
text_label_columns = []
# Load the CSV files with proper index_col
W_df = pd.read_csv("W_df.csv", index_col=0)
b_df = pd.read_csv("b_df.csv", index_col=0)

# Convert DataFrame W to a list of lists
W = W_df.values.tolist()
b = b_df.values.tolist()
print(W)
...
grid_df = pd.read_csv("C:/Users/wccha/Documents/Rutgers/AI/grid_df.csv")
...
for _ in range(num_sims):
  ...
  model1_input_df_rescued.to_csv('C:/Users/wccha/Documents/Rutgers/AI/rescue_temp.csv')
  ...
  model1_input_df_caught.to_csv('C:/Users/wccha/Documents/Rutgers/AI/caught_temp.csv')

  model1_input_df_combined = pd.concat([model1_input_df_combined, model1_input_df_caught])

  model1_input_df_combined.to_csv('C:/Users/wccha/Documents/Rutgers/AI/combined-temp.csv')


print("RESCUED DF")
# model1_input_df_rescued['final_result']='RESCUED'
print(model1_input_df_rescued)
model1_input_df_rescued.to_csv('C:/Users/wccha/Documents/Rutgers/AI/rescued.csv')
...
# model1_input_df_caught['final_result']='CAUGHT'
print(model1_input_df_caught)
model1_input_df_caught.to_csv('C:/Users/wccha/Documents/Rutgers/AI/caught.csv')

# model1_input_df_combined = pd.concat([model1_input_df_combined, model1_input_df_caught])

model1_input_df_combined.to_csv('C:/Users/wccha/Documents/Rutgers/AI/combined.csv')
